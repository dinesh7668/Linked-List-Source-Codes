...
struct Node *deleteNodeAfter(struct Node *head, int data) {
    struct Node *temp = head;
    ...
    if (temp == NULL || temp->next == NULL) {
        printf("No node exists after the node with data %d.\n", data);
        return head;
    }
...
int main()
{
    ...
    printf("Enter the data to delete node After the data : ");
    scanf("%d",&val);
